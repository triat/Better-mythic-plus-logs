// Built by `just web-build`. `bun build --compile` embeds these four files;
...
import whConfigJs from "../web/dist/wh-config.js" with { type: "file" };
...
export const WEB_ASSETS = { index: indexHtml as unknown as string, appJs, appCss, whConfigJs };
